  ...
  return (
    <div className="bg-[#f4e6df]">
      ...
      <header className="relative w-full flex flex-col items-center justify-center overflow-hidden bg-[#f4e6df]">
        <div className="relative w-full max-w-[1100px] px-5 flex flex-col items-center gap-6 text-[#333] py-12">
          {/* Hero Image */}
          <div className="w-full max-w-[900px] h-[450px] md:h-[550px] rounded-md overflow-hidden relative">
            <Image 
        ...
        <div className="max-w-[900px] mx-auto px-5 pb-16 flex flex-col items-center text-center">
          <h3 className="text-[1.5rem] font-semibold leading-tight mb-6 text-black whitespace-nowrap">
      ...
      {/* Content Section */}
      <main className="w-full max-w-[98vw] mx-auto px-5 pt-16 pb-10">
        
        {/* Weight Management Card */}
        <Link href="/weight-management" className="block">
          <section className="consultation-card bg-[#f8f9fa] border border-[#7a8ba0] rounded mb-8 overflow-hidden flex flex-col md:flex-row min-h-[500px] md:min-h-[500px] p-8 md:p-12 gap-6 transition-all hover:shadow-sm hover:bg-white cursor-pointer">
            ...
            <div className="flex-[1.2] flex flex-col justify-center items-center text-center py-4">
              ...
              <h2 className="serif-text text-[2.5rem] mb-4 text-[#333333] leading-tight font-normal tracking-[0.02em]">
        ...
        <Link href="/fitness" className="block">
          <section className="consultation-card bg-[#f8f9fa] border border-[#7a8ba0] rounded mb-8 overflow-hidden flex flex-col md:flex-row-reverse min-h-[500px] md:min-h-[500px] p-8 md:p-12 gap-6 transition-all hover:shadow-sm hover:bg-white cursor-pointer">
            <div className="flex-1 relative aspect-[4/3] rounded overflow-hidden shadow-inner">
              <Image 
      ...
      <div className="w-full max-w-[98vw] mx-auto px-5 pb-[100px]">
        <div className="bg-white rounded-lg p-12 md:p-16 shadow-md text-center">
          <h3 className="text-[2.5rem] font-semibold mb-8 text-[#333]">
            This is your moment to choose growth.<br />To choose strength. To choose yourself.
          </h3>
          <p className="text-[2.5rem] text-[#555] mb-10">
          ...
          <Link 
            href="/contact"
            className="inline-block bg-[#333333] border border-[#333333] text-white px-[40px] py-4 font-bold no-underline uppercase text-[0.8rem] tracking-wide rounded transition-colors shadow-[0_2px_4px_rgba(0,0,0,0.1)] hover:bg-[#1a1a1a]"
          >
