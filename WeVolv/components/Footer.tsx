...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: 'var(--footer-bg)', color: 'var(--footer-text)', padding: '0 40px 0', margin: 0 }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Company Info */}
          <div className="pb-10 pt-6">
            <span className="serif-text text-2xl tracking-wider block mb-4 font-bold">WEVOLV</span>
          ...
          <div className="border-t md:border-t-0 md:border-l border-gray-300 md:pl-10 h-full pb-10 md:pt-6">
            <h5 className="serif-text text-2xl mb-5 font-semibold">Shop</h5>
          ...
          {/* Learn Links */}
          <div className="border-t md:border-t-0 md:border-l border-gray-300 md:pl-10 h-full pb-10 md:pt-6">
            <h5 className="serif-text text-2xl mb-5 font-semibold">Learn</h5>
            <ul className="space-y-2">
              <li className="text-xs uppercase tracking-wide font-medium">
          ...
          {/* Information Links */}
          <div className="border-t md:border-t-0 md:border-l border-gray-300 md:pl-10 h-full pb-10 md:pt-6">
            <h5 className="serif-text text-2xl mb-5 font-semibold">Information</h5>
            <ul className="space-y-2">
              <li className="text-xs uppercase tracking-wide font-medium">
                <Link href="/programs-faq" className="hover:opacity-70 transition-opacity">
                  FAQ
